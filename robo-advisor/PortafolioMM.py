...
class RoboAdvisorMM(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        riskModel.AddRiskManagement(MaximumUnrealizedProfitPercentPerSecurity(0.1))
    ...
    def Rebalancing(self):
        ...
        for i in range(len(data)):
            ...
            self.SetHoldings("NOBL", 0.15)
            self.SetHoldings("VUG", 0.1)
