...
# Creamos la clase que va a contener todo el Robo-Advisor para un perfil moderado con un
...
class RoboAdvisorMC(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        riskModel = CompositeRiskManagementModel(MaximumDrawdownPercentPortfolio(0.05))
