...
# horizonte de inversión a mediano plazo. Este algoritmo tiene el Asset Allocation clasico de markowitz  
# y el sistema all weather portfolio
class RoboAdvisorCM(QCAlgorithm):
