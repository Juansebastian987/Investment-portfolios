...
# horizonte de inversión a corto plazo. Este algoritmo tiene el Asset Allocation clasico de markowitz  
# y el sistema all weather portfolio
class RoboAdvisorCC(QCAlgorithm):
