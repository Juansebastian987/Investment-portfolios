...
# Creamos la clase que va a contener todo el Robo-Advisor para un perfil conservador con un
# horizonte de inversión a largo plazo. Este algoritmo tiene el Asset Allocation clasico de markowitz  
# y el sistema all weather portfolio
class RoboAdvisorCL(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        tickers = ["XLU","VO","VB","VTI","NOBL","XLV","XLY","GLD", "IEI"]
        ...
        riskModel = CompositeRiskManagementModel(MaximumDrawdownPercentPortfolio(0.1))
        riskModel.AddRiskManagement(MaximumUnrealizedProfitPercentPerSecurity(0.05))
    ...
    def OnData(self, data):
        # Guarda el precio de cierre del ETF IEI
        benchmark = self.Securities["IEI"].Close
